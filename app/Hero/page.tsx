  ...
  return (
    <div className='flex'>
        <div className="ml-[173px] mt-[52px]">
            ...
            <p className="text-[32] font-normal leading-5">Order a one-time box for the footy fanatic in your life or join the ever-growing club on a mystery football shirt subscription!</p>
        </div>
